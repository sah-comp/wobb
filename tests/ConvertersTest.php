...
class ConvertersTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConverterMySqlDate()
    {
        ...
        $this->assertEquals(NULL, $converter->convert('0000-00-00'));
    }
    ...
    public function testConverterMySqlTime()
    {
        ...
        $this->assertEquals(NULL, $converter->convert(null));
        $this->assertEquals(NULL, $converter->convert('00:00:00'));
    }
    ...
    public function testConverterMySqlDatetime()
    {
        ...
        $this->assertEquals(NULL, $converter->convert(null));
        $this->assertEquals(NULL, $converter->convert('0000-00-00 00:00:00'));
    }
}
