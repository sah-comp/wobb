...
<body>
    ...
    <htmlpageheader name="tkheader" style="display: none;">
        <table width="100%">
            <tr>
                ...
                <td width="40%" style="text-align: right;"><?php echo I18n::__('openitem_text_header', null, array($fy, $nickname)) ?></td>
            </tr>
        </table>
    </htmlpageheader>
    <htmlpagefooter name="tkfooter" style="display: none;">
        <div style="border-top: 0.1mm solid #000000; font-size: 9pt; text-align: center; padding-top: 3mm;">
            <?php echo I18n::__('openitem_text_page') ?> {PAGENO} <?php echo I18n::__('openitem_text_of') ?> {nbpg}
        </div>
    </htmlpagefooter>
    ...
    <table class="openitem" width="100%">
        <thead>
            <tr>
                <th width="5%"><?php echo I18n::__('openitem_label_name') ?></th>
                <th width="5%"><?php echo I18n::__('openitem_label_dateofslaughter_list') ?></th>
                <th width="5%"><?php echo I18n::__('openitem_label_person_account') ?></th>
                <th width="5%"><?php echo I18n::__('openitem_label_person_name') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_totalnet') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_bonusnet') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_costnet') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_totalnetnormal') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_totalnetfarmer') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_totalnetother') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_vatvalue') ?></th>
                <th width="10%" class="number"><?php echo I18n::__('openitem_label_totalgros') ?></th>
            </tr>
        </thead>
        <tbody>
        <?php foreach ($records as $_id => $_record): ?>
            <tr class="openitem-kind-<?php echo $_record->kind ?>">
        ...
        <?php endforeach ?>
            <tr>
                <td class="bt bb emphasize"><?php echo I18n::__('openitem_label_total') ?></td>
                <td class="bt bb">&nbsp;</td>
                <td class="bt bb">&nbsp;</td>
                <td class="bt bb">&nbsp;</td>
