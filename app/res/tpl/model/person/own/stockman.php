...
<div class="row">
    ...
    <div class="span1">
        <input
            id="person-<?php echo $record->getId() ?>-stockman-<?php echo $index ?>-relsprice"
            type="text"
            class="number"
            name="dialog[ownStockman][<?php echo $index ?>][relsprice]"
            value="<?php echo htmlspecialchars($_stockman->decimal('relsprice', 3)) ?>" />
    </div>
    <div class="span1">
        <input
