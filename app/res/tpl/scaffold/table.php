...
<?php if ( ! $_gestalt = R::findOne('gestalt', ' name = ?', [$record->getMeta('type')])): ?>
<?php $_attributes = [
        'name'   => 'id',
        'sort'   => [
...
<table>
    ...
    <caption>
        <?php echo I18n::__('scaffold_caption_index', null, [$total_records]) ?>
    </caption>
        ...
        <tr
            ...
            <td>
                <a
                	...
                	href="<?php echo Url::build('/admin/%s/edit/%d/%d/%d/%d/%s/', [$_record->getMeta('type'), $_record->getId(), $offset, $order, $dir, $layout]) ?>">
