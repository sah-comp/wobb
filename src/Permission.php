...
class Permission extends Controller
{
     ...
     * @return bool
     */
    public static function check($user, $domain, $action_name)
    {
        if ($user->isadmin) {
            return true;
        }
     ...
     * @return bool
     */
    public static function validate($user, $domain, $action_name)
    {
        if (! $user->sharedRole) {
            return false;
        }
        ...
        foreach ($user->sharedRole as $id => $role) {
            if (isset($permission->sharedRole[$id])) {
                return true;
            }
        }
        return false;
     ...
     * @return $permission
     */
    public static function getPermission($domain, $action_name)
    {
